...
public class Magasin {
    ...
    private double PourcentageDesDons;
    ...
    public double getPourcentageDesDons() {
        return PourcentageDesDons;
    }

    public void setPourcentageDesDons(double pourcentageDesDons) {
        PourcentageDesDons = pourcentageDesDons;
    }

    public void mettreAJourLePourcentageDesDons() {
        formatEnDollard.setRoundingMode(RoundingMode.DOWN);
        setPourcentageDesDons(Double.parseDouble(formatEnDollard.format(calculPourcentageDesDons()).replace(',', '.')));
    }

    private double calculPourcentageDesDons() {
        double totalAvecTaxesDesFactures = 0.00;
        for (Facture facture : listeDeFactures) {
            totalAvecTaxesDesFactures += Double.parseDouble(facture.getTotalAvecTaxes().replace(',', '.'));
        }

        return totalDesDons * 100 / totalAvecTaxesDesFactures;
    }
    ...
    public void ajouterFacture(Facture nouvelleFacture) {
        ...
        mettreAJourLePourcentageDesDons();
    }
